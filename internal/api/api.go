...
import (
	"context"
	"errors"
	"go-planner/internal/api/spec"
	"go-planner/internal/pgstore"
	"net/http"
...
func (api API) PatchParticipantsParticipantIDConfirm(w http.ResponseWriter, r *http.Request, participantID string) *spec.Response {
	...
	if participant.IsConfirmed {
		return spec.PatchParticipantsParticipantIDConfirmJSON400Response(spec.Error{Message: "participant already confirm"})
	}
